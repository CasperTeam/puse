...
CATLOGO = "https://telegra.ph//file/c0b4dbd3945940a313249.jpg"
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**Catuserbot"):
            buttons = [
                (
                    ...
                    Button.url("Repo", "https://github.com/CasperTeam/puse"),
                )
            ]
            ...
            result = builder.article(
                ...
                text=f"🔒 A whisper message to {saya}, Only he/she can open it.",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
            if jsondata:
            ...
            result = builder.article(
                title="© saya",
                description="Help menu for saya",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/CasperTeam/puse"),
                Button.url(
                    "Deploy",
                    "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FCasperTeam%2Ftelugu&template=https%3A%2F%2Fgithub.com%2FCasperTeam%2Ftelugu",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        result = types.InputBotInlineResult(
            ...
            type="photo",
            title="𝘾𝙖𝙩𝙐𝙨𝙚𝙧𝙗𝙤𝙩",
            description="dont copy",
            url="https://github.com/CasperTeam/puse",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
