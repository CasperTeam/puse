    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await catub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph//file/c0b4dbd3945940a313249.jpg",
                caption="**Satya Is Now Running.**",
                buttons=[(Button.url("Support", "https://t.me/a_l_satya"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
print(
    f"I am started\
      \nIf you have problem, head to https://t.me/a_l_satya"
)
print("➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖")
